    ...
    <div className="min-h-screen bg-[#020202] text-white pt-12 pb-20 px-10">
      <div className="max-w-7xl mx-auto space-y-32">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-16 py-20 border-y border-white/5">
           {[
             ...
             <div key={i} className="space-y-6 group">
                <div className="w-14 h-14 rounded-2xl bg-zinc-900 border border-white/10 flex items-center justify-center group-hover:border-[#F1F5F9] transition-all duration-500">
        ...
        <section className="space-y-16">
           <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              ...
              <div className="flex items-center space-x-6 text-[10px] font-bold text-gray-500 uppercase tracking-widest">
                 <button className="text-white border-b-2 border-[#F1F5F9] pb-1">All Roles</button>
                   ...
                   <div key={i} className="group p-10 flex flex-col md:flex-row items-center justify-between hover:bg-white/[0.02] transition-colors gap-8">
                      <div className="space-y-4 flex-1">
                         <div className="flex items-center space-x-4">
                            <span className="text-[#F1F5F9] text-[10px] font-bold uppercase tracking-widest leading-none">{job.department}</span>
                            <span className="w-1 h-1 bg-gray-700 rounded-full"></span>
                            <span className="text-gray-500 text-[10px] font-bold uppercase tracking-widest leading-none">{job.type}</span>
                         </div>
                         <h4 className="text-3xl font-bold italic tracking-tight uppercase group-hover:text-[#F1F5F9] transition-colors">{job.title}</h4>
                      </div>
        ...
        <section className="text-center space-y-8 py-20">
           ...
           <Link href="/contact" className="inline-flex items-center space-x-3 text-[#F1F5F9] font-bold text-xs uppercase tracking-widest hover:translate-x-2 transition-transform">
