      ...
      <div className="max-w-7xl mx-auto space-y-32">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12">
           <div className="bg-[#111] border border-white/5 rounded-[3rem] p-12 lg:p-20 space-y-12 relative overflow-hidden group">
              ...
              <button className="w-full py-5 rounded-2xl bg-white text-black font-bold text-xs uppercase tracking-[0.3em] hover:bg-[#F1F5F9] hover:text-white transition-all flex items-center justify-center space-x-3 shadow-lg relative z-10">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              {[
                ...
                <div key={i} className="space-y-6 border-l border-white/10 pl-8">
                   <p className="text-[10px] font-bold text-[#F1F5F9] uppercase tracking-widest">{news.source} • {news.date}</p>
