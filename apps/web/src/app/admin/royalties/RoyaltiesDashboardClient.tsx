                      ...
                      <tr key={pool.id} className="hover:bg-white/[0.02] transition-all group">
                         <td className="py-8 pl-8">
                            <div className="flex items-center gap-4">
                               <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-[#A855F7]">
                         ...
                         <td className="py-8">
                            <span className={`px-3 py-1 rounded-full text-[9px] font-bold uppercase tracking-widest border ${pool.status === 'PAID' ? 'bg-green-500/10 border-green-500/20 text-green-500' : 'bg-[#A855F7]/10 border-[#A855F7]/20 text-[#A855F7]'}`}>
                               {pool.status}
                            </span>
                         </td>
                         <td className="py-8 pr-8 text-right">
                            ...
                            <button className="text-[10px] font-bold uppercase tracking-widest text-[#A855F7] hover:text-white transition-colors mt-2">View Report <ArrowRight className="w-3 h-3 inline ml-1" /></button>
                         </td>
                      </tr>
                    ))}
                    {pools.length === 0 && (
