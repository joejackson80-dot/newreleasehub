  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white selection:bg-[#A855F7] selection:text-white">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden border-b border-white/5 px-4 sm:px-8">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full sm:w-[1000px] h-[600px] bg-[#A855F70d] rounded-full blur-[100px] sm:blur-[120px] -z-0"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 sm:gap-16">
            ...
            <div className="space-y-8 group">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl sm:rounded-3xl bg-[#111] border border-white/10 flex items-center justify-center text-[#A855F7] group-hover:border-[#A855F780] transition-all">
      ...
      <section className="py-32 bg-[#050505]">
        <div className="max-w-7xl mx-auto px-6 md:px-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-12">
            <div className="space-y-4">
              <h2 className="text-[#A855F7] text-[10px] font-bold uppercase tracking-[0.3em]">The Artist Journey</h2>
            ...
            <div className="space-y-10">
              {[
                ...
                <div key={i} className="flex space-x-6">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-[#A855F7] font-bold text-sm">
                    {i + 1}
                  </div>
          ...
          <div className="relative">
             ...
             <div className="absolute -bottom-10 -left-10 bg-white text-black p-10 rounded-[3rem] shadow-2xl max-w-xs space-y-4 hidden md:block">
                <ShieldCheck className="w-10 h-10 text-[#A855F7]" />
      ...
      <section className="py-32 border-y border-white/5">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-12">
          <div className="w-20 h-20 bg-[#A855F7]/10 rounded-full flex items-center justify-center mx-auto text-[#A855F7]">
      ...
      <section className="py-32">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="text-center space-y-4 mb-20">
             <p className="text-[#A855F7] text-[10px] font-bold uppercase tracking-widest">Common Questions</p>
      ...
      <section className="py-40 relative overflow-hidden">
        <div className="absolute inset-0 bg-[#A855F7]/5"></div>
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10 space-y-12">
           <h2 className="text-[clamp(3rem,12vw,6rem)] font-bold italic uppercase tracking-tighter leading-[0.8]">
             Stop streaming.<br />
             <span className="text-[#A855F7]">Start building.</span>
           </h2>
