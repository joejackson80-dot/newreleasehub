      ...
      <div className="max-w-4xl mx-auto px-6 space-y-24">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-10">
           <div className="p-10 bg-[#0A0A0A] border border-white/5 rounded-[3rem] space-y-6 relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#F1F5F9]/5 blur-3xl rounded-full"></div>
              <div className="w-16 h-16 rounded-2xl bg-[#F1F5F9]/10 text-[#F1F5F9] flex items-center justify-center">
              ...
              <div className="pt-6 border-t border-white/5 flex items-center justify-between text-[#F1F5F9]">
        ...
        <section className="text-center space-y-10">
           <div className="w-20 h-20 bg-white/5 rounded-full flex items-center justify-center mx-auto text-[#F1F5F9]">
           ...
           <Link href="/press" className="inline-block text-[10px] font-bold text-[#F1F5F9] uppercase tracking-widest hover:text-white transition-colors">Read the Network Whitepaper →</Link>
        </section>
