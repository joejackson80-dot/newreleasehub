    ...
    <div className="bg-[#020202] text-white selection:bg-[#00D2FF] selection:text-white">
      ...
      <section className="py-32 px-10">
         <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
               { icon: Globe, title: "Global Reach", body: "Artists in 40+ countries use NRH to bypass local gatekeepers and connect with a global patronage network." },
               ...
               { icon: Heart, title: "Direct Funding", body: "Patronage tiers allow your biggest fans to fund your next release directly in exchange for revenue sharing." }
            ].map((item, i) => (
