...
export default function AboutPage() {
  return (
    <div className="bg-[#020202] text-white selection:bg-[#F1F5F9] selection:text-white">
      {/* ── HERO ── */}
      <section className="relative pt-48 pb-32 px-10 border-b border-white/5 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-[#F1F5F9]/5 to-transparent"></div>
         ...
         <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="bg-white/5 border border-white/10 rounded-[3rem] p-12 space-y-12">
               <div className="space-y-6">
                  <h3 className="text-2xl font-bold uppercase italic tracking-tighter text-[#F1F5F9]">Verified Integrity.</h3>
         ...
         <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
               ...
               <div key={i} className="p-10 bg-white/5 border border-white/5 rounded-[2.5rem] space-y-6">
                  <div className="w-14 h-14 rounded-2xl bg-[#F1F5F9]/10 flex items-center justify-center text-[#F1F5F9]">
      ...
      <section className="py-48 px-10 text-center border-t border-white/5">
         <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
               <Link href="/studio/login" className="px-12 py-5 rounded-full bg-[#F1F5F9] text-white font-bold text-xs uppercase tracking-widest hover:scale-105 transition-transform shadow-lg shadow-[#F1F5F9]/20">
                  Artist Onboarding
               </Link>
