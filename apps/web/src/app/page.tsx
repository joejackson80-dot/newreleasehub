...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white selection:bg-[#A855F7] selection:text-white">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-12 animate-in fade-in slide-in-from-bottom-12 duration-1000 flex flex-col items-center lg:items-start text-center lg:text-left">
               ...
               <div className="flex flex-col sm:flex-row gap-6">
                  <Link href="/register" className="px-12 py-5 rounded-2xl bg-white text-black font-black text-[11px] uppercase tracking-[0.2em] hover:bg-[#A855F7] hover:text-white transition-all shadow-[0_0_50px_rgba(255,255,255,0.1)]">Start Building</Link>
               ...
               <div className="pt-12 border-t border-white/5 flex items-center gap-12">
                  ...
                  <div className="space-y-2">
                     <p className="text-3xl font-bold italic tracking-tighter text-[#A855F7]">Real-Time</p>
               ...
               <div className="flex flex-col md:flex-row justify-between items-end gap-8">
                  ...
                  <div className="relative group w-full md:w-auto">
                     <input
                        ...
                        className="bg-white/5 border border-white/10 rounded-full px-10 py-4 text-base focus:outline-none focus:ring-2 focus:ring-[#A855F733] transition-all w-full md:w-80 text-white"
                     />
      ...
      <section className="py-16 sm:py-20 lg:py-32 bg-[#050505] border-y border-white/5 px-4 sm:px-8 lg:px-16 overflow-hidden">
         <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
            ...
            <div className="lg:w-1/2 relative">
               <div className="absolute inset-0 bg-[#A855F7]/5 blur-[120px] rounded-full"></div>
               <div className="relative z-10 grid grid-cols-2 gap-6 rotate-3">
                  {[
                    ...
                    <div key={i} className="p-8 bg-[#111] border border-white/5 rounded-[2.5rem] space-y-4 hover:border-white/20 transition-all hover:-translate-y-2 group cursor-pointer shadow-2xl">
                       ...
                       <h4 className="text-lg font-bold uppercase italic tracking-tighter text-white group-hover:text-[#A855F7] transition-colors">{station.name}</h4>
      ...
      <section className="py-16 sm:py-20 lg:py-32 bg-[#050505] border-y border-white/5 px-4 sm:px-8 lg:px-16">
         <div className="max-w-7xl mx-auto space-y-16 sm:space-y-24">
               ...
               {[
                 ...
                 <div key={i} className="p-10 border border-white/5 rounded-3xl space-y-6 hover:bg-white/5 transition-colors group relative">
                    <div className="absolute top-8 right-8 text-[10px] font-bold text-white/10 uppercase tracking-widest">Step {item.step}</div>
                     <div className="w-14 h-14 rounded-2xl bg-[#A855F71a] flex items-center justify-center text-[#A855F7] group-hover:bg-[#A855F7] group-hover:text-white transition-all">
            ...
            <div className="mt-12 text-center flex flex-col sm:flex-row items-center justify-center gap-6">
               <Link href="/how-it-works" className="text-white font-bold text-xs uppercase tracking-widest hover:text-[#A855F7] transition-colors">
                  Learn more about the platform
               </Link>
               <span className="hidden sm:inline text-white/10">|</span>
               <Link href="/pricing" className="text-[#A855F7] font-bold text-xs uppercase tracking-widest hover:underline">
      ...
      <section className="bg-[#020202] py-16 sm:py-20 lg:py-32 border-b border-white/5 px-4 sm:px-8 lg:px-16">
         <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
            <div className="lg:col-span-1 space-y-6">
               <p className="text-[#A855F7] text-[10px] font-bold uppercase tracking-widest">Industry tools</p>
               <h3 className="text-4xl uppercase leading-tight">Everything you need to build a music business.</h3>
               <Link href="/network/board" className="inline-flex items-center space-x-3 text-[#A855F7] font-bold text-xs uppercase tracking-widest hover:translate-x-2 transition-transform">
       ...
       <section className="py-16 sm:py-20 lg:py-32 px-4 sm:px-8 lg:px-16">
          <div className="max-w-7xl mx-auto">
             <div className="text-center space-y-4 mb-12 sm:mb-20">
                <p className="text-[#A855F7] text-[10px] font-bold uppercase tracking-widest">Artist voices</p>
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
               {[
                 ...
                 <div key={i} className="space-y-6">
                    <div className="text-[#A855F7] text-6xl font-serif leading-none">&ldquo;</div>
      ...
      {/* CALL TO ACTION */}
       <section className="bg-[#111] py-24 sm:py-32 lg:py-40 text-center space-y-12 overflow-hidden relative px-4 sm:px-8">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-[#A855F71a] rounded-full blur-[150px] -z-0"></div>
         <div className="relative z-10 space-y-10">
            <h2 className="text-white text-[clamp(2.5rem,8vw,5.5rem)] leading-[0.9] uppercase max-w-4xl mx-auto break-words">
               ...
               <span className="text-[#A855F7]">music career?</span>
            </h2>
