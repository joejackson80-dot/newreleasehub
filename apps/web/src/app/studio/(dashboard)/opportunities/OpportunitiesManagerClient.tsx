               ...
               <div className="space-y-4">
                  {opportunities.map((opp) => (
                     <button
                       ...
                       className={`w-full text-left p-8 rounded-[2rem] border transition-all group relative overflow-hidden ${selectedOpp?.id === opp.id ? 'bg-white/5 border-[#A855F7]/30' : 'bg-[#0A0A0A] border-white/5 hover:border-white/10'}`}
                     >
                        ...
                        <h3 className="text-xl font-bold italic uppercase tracking-tighter group-hover:text-[#A855F7] transition-colors">{opp.title}</h3>
                  ...
                  <div className="bg-[#050505] border border-white/5 rounded-[3rem] p-10 space-y-8 relative overflow-hidden">
                     ...
                     <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 pt-8 border-t border-white/5 relative z-10">
                        <div>
                           ...
                           <p className="text-lg font-black italic text-[#A855F7]">{selectedOpp.budget || 'N/A'}</p>
                        </div>
                        <div>
                              ...
                              <div key={app.id} className="bg-[#0A0A0A] border border-white/5 p-8 rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-8 hover:border-white/10 transition-all">
                                 <div className="flex items-center gap-6">
                                    ...
                                    <div className="space-y-1">
                                       ...
                                       <div className="flex items-center gap-4">
                                          <Link href={`/${app.Artist.slug}`} target="_blank" className="text-[9px] font-black text-[#A855F7] uppercase tracking-widest flex items-center gap-1 hover:underline">
                                 ...
                                 <div className="flex items-center gap-3">
                                    <Link 
                                      ...
                                      className="p-4 rounded-xl bg-white text-black hover:bg-[#A855F7] hover:text-white transition-all"
                                    >
