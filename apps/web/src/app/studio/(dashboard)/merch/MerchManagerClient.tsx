    ...
    <div className="p-8 md:p-12 space-y-16 max-w-6xl">
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-10">
         ...
         <button 
           ...
           className="px-8 py-4 rounded-xl bg-white text-black font-black text-[10px] uppercase tracking-widest hover:bg-[#A855F7] hover:text-white transition-all shadow-2xl flex items-center gap-2"
         >
             ...
             >
                <div className="aspect-square bg-zinc-900 rounded-[2rem] overflow-hidden border border-white/5 relative">
                   ...
                   <div className="absolute top-4 left-4 flex flex-col gap-2">
                      ...
                      {item.minFanLevel > 1 && (
                        <div className="bg-[#A855F7] text-white px-3 py-1 rounded-lg text-[8px] font-black uppercase tracking-widest flex items-center gap-1">
           ...
           {merch.length === 0 && (
             <div className="col-span-full py-32 border border-dashed border-white/5 rounded-[3rem] text-center space-y-6">
                ...
                <div className="space-y-2">
                   ...
                   <button onClick={() => setShowAddModal(true)} className="text-[#A855F7] text-[10px] font-bold uppercase tracking-widest hover:underline">Initialize First Product</button>
                </div>
             </div>
           )}
        </div>
                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8">
                       <div className="md:col-span-2 space-y-3">
                          ...
                          <input 
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 text-white text-sm font-medium focus:border-[#A855F7]/40 focus:outline-none transition-all"
                       ...
                       <div className="md:col-span-2 space-y-3">
                          ...
                          <textarea 
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 text-white text-sm font-medium focus:border-[#A855F7]/40 focus:outline-none transition-all h-24"
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                             <label className="flex items-center gap-4 cursor-pointer group">
                                <input 
                                  ...
                                  className="w-6 h-6 rounded-lg bg-white/5 border border-white/10 checked:bg-[#A855F7] transition-all"
                                />
                                <div className="space-y-1">
                             ...
                             <div className="space-y-3">
                                ...
                                <select 
                                  ...
                                  className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 text-white text-xs font-bold focus:border-[#A855F7]/40 focus:outline-none transition-all"
                                >
                       ...
                       <button 
                         ...
                         className="md:col-span-2 py-6 rounded-2xl bg-white text-black font-black text-xs uppercase tracking-[0.3em] hover:bg-[#A855F7] hover:text-white transition-all shadow-2xl mt-4 flex items-center justify-center gap-3"
                       >
