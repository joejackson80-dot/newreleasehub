  ...
  return (
    <div className="p-8 md:p-12 space-y-12">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-4xl font-bold tracking-tight text-white uppercase italic">NRH Radio <span className="text-[#A855F7]">Manager.</span></h1>
        ...
        <div className="flex items-center gap-4">
           ...
           <button className="px-6 py-3 rounded-xl bg-[#A855F7] text-white font-bold text-[10px] uppercase tracking-widest hover:bg-[#00B8E0] transition-all shadow-lg">
             Radio Guidelines
           </button>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          { label: 'Total Radio Plays', value: totalPlays.toLocaleString(), icon: Radio, color: 'text-[#A855F7]' },
      ...
      {/* COMPLIANCE FOOTER */}
      <div className="bg-[#021220] border border-[#A855F7]/20 rounded-[2.5rem] p-10 flex items-center justify-between">
         <div className="flex items-center gap-6">
            <div className="w-14 h-14 rounded-2xl bg-[#A855F7]/10 text-[#A855F7] flex items-center justify-center">
         ...
         <div className="text-right">
            ...
            <p className="text-2xl font-bold text-[#A855F7] mt-1">$0.005 <span className="text-xs text-gray-600">/ play</span></p>
         </div>
      </div>
    </div>
  );
