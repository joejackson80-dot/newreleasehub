    ...
    <div className="p-6 sm:p-8 md:p-12 space-y-12 sm:space-y-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        <div className="bg-[#111] border border-white/5 p-6 rounded-2xl space-y-4 hover:border-white/10 transition-colors relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xs text-[#A855F7] mt-2 font-bold uppercase tracking-widest">Institutional Grade</p>
          </div>
        </div>

        <div className="bg-[#111] border border-white/5 p-6 rounded-2xl space-y-4 hover:border-white/10 transition-colors relative overflow-hidden group">
          <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
             <Award className="w-16 h-16 text-[#A855F7]" />
          </div>
          <div className="flex justify-between items-start relative z-10">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4">
          <Link href="/studio/releases" className="bg-[#111] border border-white/5 p-3 sm:p-4 rounded-xl flex flex-col sm:flex-row items-center sm:space-x-3 space-y-3 sm:space-y-0 hover:bg-white/5 transition-colors group text-center sm:text-left">
            <div className="w-10 h-10 rounded-lg bg-[#A855F71a] text-[#A855F7] flex items-center justify-center group-hover:bg-[#A855F7] group-hover:text-white transition-colors flex-shrink-0">
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between">
           ...
           <Link href="/studio/collabs" className="text-[10px] font-bold text-[#A855F7] uppercase tracking-widest hover:underline">View All Requests</Link>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
           <div className="bg-[#111] border border-white/5 p-6 sm:p-8 rounded-3xl space-y-6 hover:border-[#A855F74d] transition-all group">
              <div className="flex items-center justify-between">
                 ...
                 <div className="bg-[#A855F71a] px-3 py-1 rounded-lg text-[#A855F7] text-[9px] font-bold uppercase tracking-widest italic whitespace-nowrap">94% Match</div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
                 <button className="w-full sm:flex-1 py-3 rounded-xl bg-white text-black font-bold text-[9px] uppercase tracking-widest hover:bg-[#A855F7] hover:text-white transition-all">Accept</button>
