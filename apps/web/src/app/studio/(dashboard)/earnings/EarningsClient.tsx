      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-10">
        ...
        <div className="flex items-center space-x-4">
           {stripeStatus?.connected ? (
             <button className="px-8 py-4 rounded-xl bg-white text-black font-bold text-[10px] uppercase tracking-widest hover:bg-[#A855F7] hover:text-white transition-all shadow-2xl">
                Withdraw Funds
             </button>
           ) : (
             <button 
                     ...
                     <div key={i} className="flex-1 flex flex-col items-center gap-4 group">
                        <div className="w-full relative flex flex-col justify-end" style={{ height: '100%' }}>
                           <motion.div 
                              ...
                              className="w-full bg-gradient-to-t from-[#A855F7]/20 to-[#A855F7] rounded-t-xl group-hover:to-white transition-all relative"
                           >
