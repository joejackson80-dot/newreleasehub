       ...
       <header className="flex flex-col md:flex-row md:items-end justify-between gap-10">
          ...
          <div className="flex items-center space-x-4">
             ...
             <button 
               onClick={handleSave}
               disabled={isSaving}
               className="px-8 py-4 rounded-xl bg-[#A855F7] text-white font-bold text-[10px] uppercase tracking-widest hover:bg-[#00B8E0] transition-all shadow-2xl flex items-center gap-2"
             >
          ...
          <div className="lg:col-span-7 space-y-12">
             ...
             <section className="space-y-6">
                ...
                <textarea 
                  ...
                  className="w-full h-64 bg-[#111] border border-white/5 rounded-3xl p-8 text-sm text-gray-300 placeholder-gray-800 focus:outline-none focus:border-[#A855F7]/40 transition-all leading-relaxed"
                />
             </section>
             ...
             <section className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                   <div className="aspect-square bg-[#111] border border-dashed border-white/10 rounded-3xl flex flex-col items-center justify-center space-y-3 group hover:border-[#A855F7]/40 transition-all cursor-pointer">
             ...
             <div className="bg-gradient-to-br from-[#111] to-black border border-white/5 rounded-[2.5rem] p-10 space-y-8">
                ...
                <div className="pt-6 border-t border-white/5">
                   <Link href="/network/board" className="flex items-center justify-between group">
                      <span className="text-[10px] font-bold text-[#A855F7] uppercase tracking-widest">Apply for Grants</span>
