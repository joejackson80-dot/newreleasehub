              ...
              {org.releases.map((release: any) => (
                <button
                  ...
                  className={`w-full text-left p-4 rounded-2xl border transition-all flex items-center gap-4 ${
                    selectedRelease?.id === release.id 
                      ? 'bg-[#F1F5F9]/10 border-[#F1F5F9]/30 shadow-[0_0_20px_rgba(241,245,249,0.1)]' 
                ...
                >
                  ...
                  <div className="min-w-0">
                    <p className={`font-bold truncate ${selectedRelease?.id === release.id ? 'text-[#F1F5F9]' : 'text-white'}`}>
                      {release.title}
                    </p>
                      ...
                      <div className="flex-1 space-y-4">
                        <div>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button 
                              onClick={handleCopy}
                              className="p-3 bg-[#F1F5F9]/10 text-[#F1F5F9] hover:bg-[#F1F5F9]/20 transition-colors rounded-xl border border-[#F1F5F9]/20"
                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="p-6 rounded-2xl bg-black/40 border border-white/5 space-y-4">
                        <div className="flex items-center gap-3 text-white">
                          <Share2 className="w-5 h-5 text-[#F1F5F9]" />
                      ...
                      <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-900/20 to-[#F1F5F9]/10 border border-[#F1F5F9]/20 space-y-4">
                           ...
                           {selectedRelease.coverArtUrl && (
                             <>
                               ...
                               <div className="absolute inset-0 flex flex-col items-center justify-center p-8 bg-black/40">
                                 ...
                                 <p className="text-[#F1F5F9] font-black uppercase tracking-[0.2em] text-[10px]">Out Now on NRH</p>
                               </div>
                             </>
                           )}
                           ...
                           {selectedRelease.coverArtUrl && (
                             <>
                               ...
                               <div className="absolute inset-0 flex flex-col items-center justify-between py-16 px-8 bg-gradient-to-t from-black via-black/20 to-black/80">
                                 ...
                                 <div className="bg-[#F1F5F9] text-black w-full py-4 rounded-xl text-center font-black uppercase tracking-[0.2em] text-xs">
                                   Listen Now
                                 </div>
                               </div>
                             </>
