      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="space-y-16">
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-invert prose-p:text-gray-400 max-w-none">
              <p>
                We do not sell your personal data. We share information with third-party service providers (like Stripe and Resend) only as necessary to provide our services. Artist profile information is public on the network to facilitate discovery and support.
              </p>
            </div>
          </section>
          ...
          <section className="space-y-6 border-t border-white/10 pt-12">
            ...
            <p className="text-gray-400">
              ...
              <br /><br />
              <Link href="mailto:privacy@newreleasehub.com" className="text-[#A855F7] hover:underline">privacy@newreleasehub.com</Link>
            </p>
          </section>
        </div>
      </div>
