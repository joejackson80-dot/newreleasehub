            ...
            {step === 1 ? (
                      ...
                      >
                        <div className="flex justify-between items-start relative z-10">
                          <div className="space-y-2">
                             ...
                             <p className={`text-[10px] font-bold uppercase tracking-widest ${selectedTier?.id === tier.id ? 'text-gray-500' : 'text-[#A855F7]'}`}>
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                   <button onClick={() => router.push(`/${artist?.slug}`)} className="px-10 py-4 rounded-xl bg-white text-black font-bold text-[10px] uppercase tracking-widest hover:bg-[#A855F7] hover:text-white transition-all">Return to Hub</button>
          ...
          <div className="lg:col-span-5">
            <div className="sticky top-32 space-y-8">
              <div className="bg-[#111] border border-white/5 rounded-[2.5rem] p-10 space-y-10 relative overflow-hidden">
                 ...
                 <div className="space-y-6 relative z-10">
                    ...
                    <div className="flex justify-between items-center text-sm font-medium">
                       ...
                       <span className="text-[#A855F7] font-bold italic">{((selectedTier?.revenueSharePercent || 0) * 100).toFixed(0)} bps</span>
                    </div>
                 ...
                 <button 
                  ...
                  className="w-full py-5 rounded-2xl bg-[#A855F7] text-white font-bold text-[10px] uppercase tracking-[0.2em] hover:bg-[#00B8E0] transition-all shadow-[0_0_50px_rgba(51,102,255,0.3)] flex items-center justify-center space-x-3"
                 >
                    {isProcessing ? (
                      <>
              ...
              <div className="bg-white/[0.01] border border-white/5 rounded-3xl p-8 flex items-start space-x-6">
                 <Zap className="w-5 h-5 text-[#A855F7] mt-1 shrink-0" />
