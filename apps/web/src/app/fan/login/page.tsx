...
export default function FanAuthPage() {
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white flex flex-col md:flex-row selection:bg-[#F1F5F9] selection:text-white">
      {/* LEFT SIDE - VISUAL */}
         ...
         <div className="relative z-10 p-20 space-y-12 max-w-xl">
             ...
             <div className="space-y-6">
                <div className="flex items-start gap-4">
                   <div className="w-10 h-10 rounded-full bg-[#F1F5F91a] flex items-center justify-center shrink-0 mt-1">
                      <Music className="w-4 h-4 text-[#F1F5F9]" />
                   </div>
                   <div>
         ...
         <div className="w-full max-w-md space-y-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                 ...
                 <div className="space-y-3">
                    ...
                    <div className="relative">
                       <input 
                         ...
                         className="w-full bg-white/5 border border-white/10 rounded-2xl pl-12 pr-6 py-4 text-xs font-bold text-white focus:outline-none focus:border-[#F1F5F9] transition-all"
                       />
               ...
               <button 
                 type="submit" 
                 disabled={isLoading}
                 className="w-full py-5 rounded-2xl bg-[#F1F5F9] text-white font-bold text-[10px] uppercase tracking-[0.3em] hover:bg-[#00B8E0] transition-all shadow-lg shadow-[#F1F5F933] flex items-center justify-center space-x-3 disabled:opacity-50"
               >
                  {isLoading ? (
