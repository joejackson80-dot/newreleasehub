      ...
      <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto space-y-12">
        <div className="text-center max-w-3xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-black text-white uppercase tracking-tighter italic mb-4">
            Network <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#A855F7] to-[#3a7bd5]">Services</span>
          </h1>
        ...
        <FadeIn>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between mb-8 bg-[#111] border border-white/5 p-4 rounded-2xl">
            ...
            <div className="relative w-full md:w-64 shrink-0">
               ...
               <input 
                 ...
                 className="w-full bg-black border border-white/10 rounded-xl py-3 pl-10 pr-4 text-sm text-white focus:outline-none focus:border-[#A855F7]"
               />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
             {filteredServices.map(service => (
               <div key={service.id} className="bg-[#111] border border-white/5 rounded-3xl p-8 hover:border-[#A855F7]/30 transition-all group flex flex-col h-full">
                  <div className="flex justify-between items-start mb-6">
                     <div className="w-12 h-12 rounded-xl bg-black border border-white/5 flex items-center justify-center text-[#A855F7] group-hover:scale-110 transition-transform">
                        <service.icon className="w-5 h-5" />
                     </div>
                     <span className="bg-[#A855F7]/10 text-[#A855F7] px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border border-[#A855F7]/20">
                        {service.category}
                     </span>
                  </div>
                  ...
                  <div className="flex-1 space-y-4">
                     <div>
                       <h3 className="text-xl font-bold text-white tracking-tight leading-tight group-hover:text-[#A855F7] transition-colors">{service.name}</h3>
