...
function CheckoutSuccessContent() {
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white flex flex-col items-center justify-center p-8 relative overflow-hidden selection:bg-[#A855F7] selection:text-white">
      
      {/* BACKGROUND ELEMENTS */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#A855F7]/5 blur-[120px] rounded-full animate-pulse" />
      ...
      >
           ...
           <div className="space-y-6">
              <div className="flex justify-center">
                <motion.div 
                  ...
                  className="bg-[#A855F7]/10 p-8 rounded-[2.5rem] border border-[#A855F7]/20 shadow-[0_0_50px_rgba(168, 85, 247,0.1)]"
                >
                  <ShieldCheck className="w-20 h-20 text-[#A855F7]" />
                </motion.div>
              </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-[3rem] p-10 space-y-10 backdrop-blur-3xl">
           ...
           <div className="flex flex-col sm:flex-row gap-4">
              <button className="flex-1 py-4 rounded-xl bg-white text-black font-bold text-[10px] uppercase tracking-widest hover:bg-[#A855F7] hover:text-white transition-all flex items-center justify-center gap-2">
        ...
        <div className="pt-4 space-y-6">
           <button 
             ...
             className="group flex items-center space-x-3 mx-auto px-8 py-4 bg-[#A855F7] rounded-full text-[10px] font-bold uppercase tracking-widest text-white hover:scale-105 transition-all shadow-xl shadow-[#A855F7]/20"
           >
