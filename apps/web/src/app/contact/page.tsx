...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-[#020202] text-white pt-24 pb-20 px-6 md:px-10 selection:bg-[#F1F5F9] selection:text-white">
         ...
         <div className="space-y-16">
           ...
           <div className="space-y-10">
              <div className="flex items-start space-x-6">
                 <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-[#F1F5F9] shrink-0">
        ...
        <div className="bg-[#111] border border-white/5 rounded-[3rem] p-12 lg:p-16 relative">
           ...
           <form className="space-y-8 relative z-10">
              ...
              <div className="space-y-3">
                 ...
                 <select className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-xs font-bold text-white focus:outline-none focus:border-[#F1F5F9] transition-all appearance-none">
              ...
              <div className="space-y-3">
                 ...
                 <textarea 
                   ...
                   className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-xs font-bold text-white focus:outline-none focus:border-[#F1F5F9] transition-all resize-none"
                 />
              </div>
              <button className="w-full py-5 rounded-2xl bg-[#F1F5F9] text-white font-bold text-[10px] uppercase tracking-[0.3em] hover:bg-[#00B8E0] transition-all shadow-lg shadow-[#F1F5F9]/20 flex items-center justify-center space-x-3">
