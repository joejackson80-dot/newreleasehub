...
export default function EnterpriseFeedClient() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-[#F1F5F9] selection:text-white font-sans pt-12 pb-32">
            ...
            {[
               ...
               <div key={i} className="bg-[#111] border border-white/5 p-6 rounded-2xl space-y-2 hover:border-white/20 transition-all group">
                  <div className="flex justify-between items-center">
                     ...
                     <stat.icon className="w-3.5 h-3.5 text-gray-700 group-hover:text-[#F1F5F9] transition-colors" />
                  </div>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-10 mt-12 grid grid-cols-1 lg:grid-cols-3 gap-10">
         ...
         <div className="space-y-8">
            <div className="bg-gradient-to-br from-[#F1F5F9]/20 to-purple-500/20 border border-white/10 rounded-3xl p-10 space-y-6">
               ...
               <button className="w-full py-4 rounded-xl bg-white text-black font-bold text-[10px] uppercase tracking-widest hover:bg-[#F1F5F9] hover:text-white transition-all shadow-xl">
                  Run Roster Audit
               </button>
            </div>
            ...
            <Link href="/studio/login" className="flex items-center justify-between p-6 bg-[#020202] border border-white/10 rounded-2xl group hover:border-[#F1F5F9] transition-all">
               <div className="flex items-center space-x-4">
               ...
               <ArrowUpRight className="w-4 h-4 text-gray-800 group-hover:text-[#F1F5F9] transition-all" />
            </Link>
         </div>
