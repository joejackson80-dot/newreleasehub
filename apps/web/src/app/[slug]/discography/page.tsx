...
export default function DiscographyPage() {
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white selection:bg-[#F1F5F9] selection:text-white pt-32 pb-32 px-6 sm:px-10 lg:px-20">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
               <div className="relative w-full sm:w-64">
                  ...
                  <input 
                    ...
                    className="w-full bg-[#111] border border-white/5 rounded-2xl pl-12 pr-4 py-3.5 text-xs font-bold uppercase tracking-widest focus:outline-none focus:border-[#F1F5F966] transition-all"
                  />
               </div>
