    ...
    <div className="min-h-screen bg-[#020202] text-white selection:bg-white selection:text-black font-sans pb-32">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 px-6 md:px-10 py-6 border-b border-white/5 bg-black/40 backdrop-blur-3xl flex justify-between items-center">
         ...
         <div className="flex items-center space-x-4">
            ...
            <Link href={`/${slug}/live`} className="bg-[#A855F7] text-white px-8 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-widest hover:scale-105 transition-all shadow-lg shadow-[#A855F7]/20">Join Live Session</Link>
         </div>
      </header>
            ...
            <div className="space-y-10 md:space-y-12">
               <div className="space-y-4 md:space-y-6">
                  <div className="flex flex-wrap items-center gap-4">
                    <div className="inline-flex items-center space-x-2 bg-[#A855F7]/10 border border-[#A855F7]/20 px-4 py-1.5 rounded-full">
