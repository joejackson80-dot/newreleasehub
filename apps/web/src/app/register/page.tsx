...
export default function RegisterPage() {
  return (
    <div className="min-h-screen bg-[#020202] text-white flex flex-col font-sans selection:bg-[#F1F5F9] selection:text-white">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-20 relative overflow-hidden">
         ...
         <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#F1F5F91a] rounded-full blur-[120px]"></div>
         </div>
         ...
         <div className="max-w-4xl w-full space-y-16 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               ...
               {/* ARTIST PATH */}
               <Link href="/studio/register" className="group p-10 bg-[#0A0A0A] border border-white/5 rounded-[2.5rem] space-y-8 hover:border-[#F1F5F94d] hover:-translate-y-2 transition-all duration-500 shadow-2xl relative overflow-hidden">
                  <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity">
                     <Music className="w-32 h-32 text-[#F1F5F9]" />
                  </div>
                  <div className="w-16 h-16 rounded-2xl bg-[#F1F5F91a] flex items-center justify-center text-[#F1F5F9] group-hover:bg-[#F1F5F9] group-hover:text-white transition-all">
                  ...
                  <div className="flex items-center space-x-3 text-[#F1F5F9] font-bold text-[10px] uppercase tracking-[0.2em]">
