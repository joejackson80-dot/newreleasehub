  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-[#010A14] flex items-center justify-center">
        <div className="w-16 h-16 border-4 border-[#A855F7]/20 border-t-[#A855F7] rounded-full animate-spin" />
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#010A14] text-white">
      ...
      <div className="max-w-7xl mx-auto px-8 py-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="px-4 py-2 rounded-xl bg-[#A855F7]/10 border border-[#A855F7]/20 flex items-center gap-2">
            <Users className="w-4 h-4 text-[#A855F7]" />
            <span className="text-xs font-bold text-[#A855F7]">1,420 listening</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8 mt-12 grid grid-cols-1 lg:grid-cols-12 gap-16 pb-32">
        ...
        <div className="lg:col-span-7 space-y-12">
          ...
          <div className="space-y-4">
             ...
             <h1 className="text-6xl font-bold uppercase tracking-tighter leading-none italic">
               NRH {slug?.toString().replace('-', ' ')} <span className="text-[#A855F7]">Radio.</span>
             </h1>
          ...
          <div className="relative group">
            <div className="absolute inset-0 bg-[#A855F7]/10 blur-3xl opacity-20 -z-10 group-hover:opacity-40 transition-opacity" />
              ...
              <div className="w-64 h-64 rounded-[2rem] overflow-hidden shadow-2xl relative shrink-0">
                {nowPlaying?.imageUrl ? (
                  ...
                  <div className="w-full h-full bg-[#031B2E] flex items-center justify-center">
                    <Disc className="w-20 h-20 text-[#A855F7]/20" />
                  </div>
                )}
                {isPlaying && (
              ...
              <div className="flex-1 space-y-8 text-center md:text-left">
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
                    <Link href={`/${nowPlaying?.artistSlug}`} className="text-[#A855F7] text-xl font-bold hover:underline">
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
                  ...
                  <button className="px-8 py-4 rounded-full bg-[#A855F7] text-white font-bold text-xs uppercase tracking-widest hover:bg-[#A855F7]/80 transition-all shadow-[0_0_20px_rgba(168, 85, 247,0.3)]">
                    Become a Supporter
                  </button>
                    ...
                    {[
                      ...
                      <button 
                        ...
                        onClick={async () => {
                          ...
                          if (res.success) {
                             toast.success(`${r.emoji} Sent!`, { icon: r.emoji, style: { background: '#021220', color: '#fff', border: '1px solid #A855F7' } });
                          }
                        }}
                        className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-xl hover:bg-[#A855F7]/10 hover:border-[#A855F7]/30 transition-all hover:-translate-y-1 active:scale-90"
                      >
                        {r.emoji}
                      </button>
                    ))}
          ...
          <div className="bg-[#031B2E]/50 border border-white/5 rounded-3xl p-6 flex items-center justify-between gap-8">
             <div className="flex items-center gap-4 flex-1">
                ...
                >
                   <div className="absolute inset-0 bg-[#A855F7]" style={{ width: `${volume * 100}%` }} />
                </div>
             </div>
        ...
        <div className="lg:col-span-5 space-y-10">
              ...
              {recentlyPlayed.length > 0 ? (
                recentlyPlayed.map((track, i) => (
                  <div key={`${track.id}-${i}`} className="flex items-center gap-4 group">
                    ...
                    <button className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all hover:bg-[#A855F7] hover:text-white">
          ...
          {/* STATION PERKS */}
          <section className="bg-gradient-to-br from-[#021220] to-[#010A14] border border-[#A855F7]/20 rounded-[2.5rem] p-8 space-y-6">
             <div className="flex items-center gap-3">
             ...
             <ul className="space-y-4">
               {[
                 ...
                 <li key={i} className="flex items-center gap-3 text-[10px] font-bold text-gray-500 uppercase tracking-widest">
                   <item.icon className="w-3.5 h-3.5 text-[#A855F7]" />
                   {item.label}
                 </li>
               ))}
             </ul>
