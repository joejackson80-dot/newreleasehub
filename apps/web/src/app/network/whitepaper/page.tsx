...
export default function NetworkWhitepaper() {
  return (
    <div className="min-h-screen bg-[#020202] text-white selection:bg-[#F1F5F9] selection:text-white font-sans overflow-x-hidden">
      ...
      <section className="max-w-6xl mx-auto px-10 py-32 space-y-20">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-[#111] border border-white/5 rounded-[3rem] p-12 space-y-8">
               <div className="w-14 h-14 rounded-2xl bg-[#F1F5F9]/10 flex items-center justify-center">
                  <Zap className="w-6 h-6 text-[#F1F5F9]" />
               </div>
               <div className="space-y-4">
                  <h4 className="text-2xl font-bold italic tracking-tight text-white uppercase">Engagement Velocity (EV)</h4>
                  <p className="text-sm text-gray-600 leading-relaxed font-medium italic">
                     "Tracking the speed and consistency of support interactions. Higher velocity participants unlock prioritized asset acquisition windows."
                  </p>
               </div>
            </div>
            ...
            <div className="bg-[#111] border border-white/5 rounded-[3rem] p-12 space-y-8">
               ...
               <div className="space-y-4">
                  <h4 className="text-2xl font-bold italic tracking-tight text-white uppercase">Institutional Support Score</h4>
                  <p className="text-sm text-gray-600 leading-relaxed font-medium italic">
                     "A consolidated metric reflecting total capital support, duration of artist advocacy, and successful governance participation."
                  </p>
               </div>
            </div>
         </div>
      ...
      {/* YIELD PARTICIPATION SECTION */}
      <section className="max-w-6xl mx-auto px-10 py-32 bg-white/[0.02] border-y border-white/5 space-y-20">
         <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
            <div className="space-y-6">
               <h2 className="text-4xl md:text-6xl font-bold tracking-tighter italic uppercase text-white">Yield Participation<br />Mechanics.</h2>
               <p className="text-gray-500 max-w-xl font-medium leading-relaxed">
                  Revenue generated by assets on the network is settled in real-time according to the smart-contract defined participation shares.
               </p>
            </div>
            <div className="bg-emerald-500/10 border border-emerald-500/20 px-6 py-3 rounded-2xl flex items-center gap-3">
               <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></div>
               <span className="text-[10px] font-black text-emerald-500 uppercase tracking-widest">Settlement Engine Active</span>
            </div>
         </div>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="space-y-6 p-8 border-l border-white/5 hover:border-[#F1F5F9] transition-all group">
                 <h4 className="text-xl font-bold italic tracking-tight text-white uppercase group-hover:text-[#F1F5F9] transition-colors">{mech.title}</h4>
