  ...
  return sent ? (
    ...
    >
      <input
        ...
        className="flex-1 w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-xs font-bold tracking-widest text-white placeholder-gray-700 focus:outline-none focus:border-[#A855F7] transition-all"
      />
      <button
        type="submit"
...
export default function BoardClient({ initialOpportunities }: { initialOpportunities: any[] }) {
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white selection:bg-[#A855F7] selection:text-white font-sans pt-8 pb-20">
               ...
               <div className="relative w-full lg:w-64">
                  <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500" />
                   <input 
                     ...
                     className="w-full bg-black border border-white/10 rounded-xl pl-12 pr-4 py-3 text-xs font-bold uppercase tracking-widest text-white focus:outline-none focus:border-[#A855F766]" 
                   />
               </div>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-10">
         {filteredOpps.length > 0 ? (
                 ...
                 <div key={opp.id} className="bg-[#111] border border-white/5 rounded-3xl p-8 hover:border-white/20 transition-all flex flex-col h-full group">
                   ...
                   <h3 className="text-xl font-bold mb-2 line-clamp-2">{opp.title}</h3>
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      {opp.posterIsVerified && <ShieldCheck className="w-4 h-4 text-[#A855F7]" />}
                    </div>
                   ...
                   {opp.description && (
                     <div className="mb-6">
                       ...
                       <button className="text-xs font-bold text-[#A855F7] uppercase tracking-widest mt-2 hover:text-white transition-colors">
                         Read more
                       </button>
                     </div>
                   )}
                      ...
                      <div className="pt-6 border-t border-white/5 flex items-center justify-between">
                        ...
                        {typeStr === 'PROPOSAL' ? (
                          ...
                          <button 
                            ...
                            className="flex items-center gap-2 text-[#A855F7] hover:text-white transition-colors text-xs font-bold uppercase tracking-widest"
                          >
           ...
           <div className="py-32 text-center space-y-10 bg-[#111] border border-dashed border-white/10 rounded-[3rem] px-4">
              <div className="w-20 h-20 bg-[#A855F7]/10 rounded-2xl flex items-center justify-center mx-auto text-[#A855F7]">
            ...
            <div className="relative w-full max-w-lg bg-[#0A0A0A] border border-white/10 rounded-[2rem] sm:rounded-[2.5rem] p-8 sm:p-10 space-y-8 shadow-2xl">
              ...
              {isSuccess ? (
                 <div className="py-12 text-center space-y-6">
                    <div className={`w-16 h-16 ${selectedOpp.type === 'PROPOSAL' ? 'bg-[#A855F71a] text-[#A855F7]' : 'bg-[#10b9811a] text-emerald-500'} rounded-2xl flex items-center justify-center mx-auto`}>
                   ...
                   <form onSubmit={handleApply} className="space-y-6">
                      {selectedOpp.type === 'PROPOSAL' ? (
                         <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                               ...
                               <textarea 
                                 ...
                                 className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-sm text-white focus:outline-none focus:border-[#A855F766] transition-all h-32 resize-none"
                               />
                            </div>
                         </div>
                      ) : (
                         <div className="space-y-6">
                            ...
                            <div className="p-4 bg-[#A855F71a] rounded-2xl border border-[#A855F7]/20 flex items-center gap-4">
