      ...
      <div className="max-w-5xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            { label: 'Streams Audited', value: '0', icon: Activity, color: 'text-[#A855F7]' },
          ].map((stat, i) => (
        ...
        <div className="bg-[#0A0A0A] border border-white/5 rounded-[3rem] p-12 space-y-8">
          ...
          <div className="flex items-center gap-4">
            <input 
              ...
              className="flex-1 bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-sm font-bold text-white placeholder:text-gray-700 outline-none focus:border-[#A855F7]/50 transition-colors"
            />
