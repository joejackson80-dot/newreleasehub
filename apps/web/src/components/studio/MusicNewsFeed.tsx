    ...
    <section className="space-y-6">
      <div className="flex items-center justify-between">
         <div className="flex items-center space-x-3">
            ...
            <div className="bg-[#A855F71a] px-2 py-1 rounded text-[#A855F7] text-[8px] font-bold uppercase tracking-widest">Live</div>
         </div>
      ...
      <div className="bg-[#111] border border-white/5 rounded-2xl overflow-hidden relative">
        {isLoading ? (
          <div className="p-10 flex flex-col items-center justify-center space-y-4 text-gray-500">
             <Activity className="w-8 h-8 animate-pulse text-[#A855F7]" />
            ...
            {articles.map((article, i) => (
              ...
              >
                <div className="flex-1 min-w-0 pr-4">
                  <h3 className="text-sm font-bold text-white leading-tight group-hover:text-[#A855F7] transition-colors line-clamp-2">
                    {article.title}
                  </h3>
                ...
                <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 group-hover:bg-[#A855F7] group-hover:text-black transition-all flex-shrink-0">
