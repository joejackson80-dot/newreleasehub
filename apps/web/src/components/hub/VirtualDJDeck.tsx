  ...
  return (
    <div className={`${baseClass} w-full transition-all duration-700 relative group`}>
      ...
      <button 
        ...
        className="absolute -top-4 -right-4 bg-[#A855F7] text-white p-3 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity z-[100]"
      >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            ...
            <div className="w-full bg-black/40 rounded-3xl p-6 border border-white/5 space-y-4">
               <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-2">
                     ...
                     <span className="text-[10px] font-bold text-[#A855F7] font-mono tracking-tighter">{bpm.toFixed(2)}</span>
                  </div>
               </div>
         ...
         <div className="bg-black/20 border border-white/5 rounded-[3rem] p-10 flex flex-col items-center space-y-12 shadow-2xl">
            <div className="grid grid-cols-2 gap-12 w-full">
               ...
               <div className="flex flex-col items-center space-y-3">
                  <div className="w-12 h-12 rounded-full bg-[#181818] border-2 border-black shadow-lg relative cursor-pointer active:scale-95 transition-transform group">
                     <div className="absolute top-1 left-1/2 -translate-x-1/2 w-0.5 h-3 bg-white/40 rounded-full group-hover:bg-[#A855F7]"></div>
                  </div>
            ...
            <div className="flex space-x-16 h-56 py-6">
               <div className="w-10 h-full bg-black/40 rounded-full border border-white/5 relative flex justify-center p-1 group">
                  <motion.div 
                    ...
                    className="w-8 h-12 bg-[#222] rounded-lg border border-black shadow-xl cursor-ns-resize absolute top-4 z-10 group-hover:bg-[#A855F7] transition-colors"
                  />
               ...
               <div className="w-10 h-full bg-black/40 rounded-full border border-white/5 relative flex justify-center p-1 group">
                  <motion.div 
                    drag="y"
                    dragConstraints={{ top: 0, bottom: 160 }}
                    className="w-8 h-12 bg-[#222] rounded-lg border border-black shadow-xl cursor-ns-resize absolute top-12 z-10 group-hover:bg-[#A855F7] transition-colors"
                  />
                  <div className="h-full w-[2px] bg-white/5 absolute left-1/2 -translate-x-1/2" />
               </div>
            </div>
            ...
            <div className="flex items-center space-x-8">
               <button onClick={onToggle} className={`w-16 h-16 rounded-full flex items-center justify-center transition-all ${isPlaying ? 'bg-[#A855F7] text-white shadow-[0_0_30px_rgba(51,102,255,0.4)]' : 'bg-white text-black hover:scale-105'}`}>
         ...
         <div className="flex flex-col items-center space-y-10">
            <div className="w-full bg-black/40 rounded-3xl p-8 border border-white/5 space-y-8 min-h-[300px]">
               ...
               <div className="space-y-4 max-h-[200px] overflow-y-auto no-scrollbar">
                  {queue.map((item) => (
                    <div key={item.id} className="flex items-center justify-between group/item p-3 bg-white/5 rounded-xl border border-white/5 hover:border-[#A855F7]/30 transition-all">
            ...
            <div className="w-full bg-[#A855F7]/5 border border-[#A855F7]/10 rounded-2xl p-4 flex items-center justify-between">
               <div className="flex items-center space-x-3">
               ...
               <span className="text-[10px] font-bold text-[#A855F7] font-mono">128.00 SYNC</span>
            </div>
         </div>
