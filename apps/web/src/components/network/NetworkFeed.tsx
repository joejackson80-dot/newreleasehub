      ...
      <AnimatePresence mode="popLayout">
        {items.map((item, index) => (
          <motion.div
            ...
            className="group relative bg-[#0A0A0A] border border-white/5 rounded-3xl p-6 hover:border-[#A855F7]/30 transition-all shadow-xl overflow-hidden"
          >
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-2">
                   <p className="text-[10px] font-bold text-[#A855F7] uppercase tracking-widest truncate">{item.artist.name}</p>
