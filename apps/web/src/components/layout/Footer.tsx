          ...
          <div className="lg:col-span-2 space-y-8 sm:space-y-10">
            <Link href="/" className="flex flex-col space-y-6 sm:space-y-8 group">
               <div className="w-14 h-14 rounded-2xl bg-transparent flex items-center justify-center hover:scale-105 transition-transform">
                  <img src="/images/nrh-logo.png" alt="NRH Logo" className="w-full h-full object-contain drop-shadow-[0_0_10px_rgba(241,245,249,0.3)]" />
               </div>
               <div className="space-y-1">
                  <span className="text-lg font-bold tracking-tighter uppercase text-white italic leading-none">New Release Hub<span className="text-[#F1F5F9]">.</span></span>
               </div>
            </Link>
          ...
          <div className="space-y-8">
            ...
            <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); console.log('Subscribed:', email); setEmail(''); }}>
               <input 
                 ...
                 className="w-full bg-white/5 border border-white/5 rounded-xl px-4 py-3 text-[10px] font-bold uppercase tracking-widest text-white placeholder-gray-700 focus:outline-none focus:border-[#F1F5F9] transition-all"
               />
               <button 
                 type="submit"
